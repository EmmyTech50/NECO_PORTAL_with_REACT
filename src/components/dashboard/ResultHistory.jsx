        ...
        <GridItem h="100vh" width="100%" overflowX="hidden">
          ...
          <Box px={4}>
            <Box display="flex" justifyContent="space-between" alignItems="center" mt={10} flexWrap="wrap" gap={4}>
              <FormControl borderRadius="5px" w={{ base: 'full', md: '400px' }} bgColor="#e0e0e0">
                <InputGroup>
                  <InputRightElement pointerEvents="none" display="flex" justifyContent="center" alignItems="center">
                    <Search2Icon color="black" />
                  </InputRightElement>
                  <Input type="text" placeholder="Search by Name or Registration Number" size="lg" />
                </InputGroup>
              </FormControl>

              <Select placeholder="All" w={{ base: 'full', md: '100px' }} bgColor="#e0e0e0">
